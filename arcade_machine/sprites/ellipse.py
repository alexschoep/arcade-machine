...
from pygame.draw import ellipse as pygame_ellipse
...
class Ellipse(Group):
    ...
    def change_ellipse_dimension(self, new_width, new_height):
    ...
    def change_ellipse_color(self, new_color):
        self.color = new_color
        self.draw_ellipse()

    def change_ellipse_position(self, new_x, new_y, new_anchor):
        self.x_pos = new_x
        self.y_pos = new_y
